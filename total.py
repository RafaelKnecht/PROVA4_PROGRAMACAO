...
while True:
        ...
        print("O usuário gostaria de saber se o carro " , nome_carro, "está disponível e gostaria de pagar" , preco_carro, " reais nesse carro.")
        ...
        if resultado_procura == "Carro encontrado!":
            ...
            print("O usuário gostaria de um carro", nome_carro ,"na qualidade de", qualidade_carro,". O valor do", nome_carro ,"é o mesmo recebido na entrada. Já o valor do", qualidade_carro ,"é recebido através da avaliação do preço.")
